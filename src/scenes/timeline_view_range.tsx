...
import scroll_video_000 from "/timeline_view_range_001.mp4";
import scroll_video_001 from "/timeline_view_range_002.mp4";
...
@keyframes appear {
 ...
 `;
  ...
  yield videoNode().add(video0node);
